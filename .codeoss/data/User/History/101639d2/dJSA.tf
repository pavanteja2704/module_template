module "monitoring_alert_policy" {
  ...
  condition_threshold           = each.value.
  denominator_aggregations      = each.value.
  forecast_options              = each.value.
  condition_matched_log         = each.value.
  condition_prometheus_query_language = each.value.
  alert_strategy                = each.value.
  notification_rate_limit       = each.value.
  notification_channel_strategy = each.value.
  documentation                 = each.value.
