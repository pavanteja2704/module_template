...
variable "notification_channels" {
  type = list(string)
  description = ""
  default = ["projects/hardy-binder-411706/notificationChannels/pavan"]
}
variable "severity" {
  type = string
  description = ""
...
variable "alert_strategy" {
  ...
  default = [ {
    ...
    notification_channel_strategy = [ {
      notification_channel_names  = ["projects/hardy-binder-411706/notificationChannels/pavan projects/hardy-binder-411706/notificationChannels/9156200506378571660"]
